    ...
    return (
        <nav className="nav">
            ...
            <div className="nav__menu">
                <span onClick={()=>props.state.changeLanguage((props.state.language !== 'EN')? 'EN' : 'ES' )} className="nav__menu__item">
                    <FontAwesomeIcon icon="globe-americas" />
                    <span className="nav__menu__item__languages">{props.state.localization.getLanguage()}</span>
                </span>
                <span onClick={()=>props.state.changeTheme((props.state.theme !== 'white')? 'white' : 'black' )} className="nav__menu__item">
